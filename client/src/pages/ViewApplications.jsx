...
const ViewApplications = () => {
  ...
  <div className='flex items-center justify-center h-[70vh]'>
    ...
    <div className='container mx-auto p-4'>
        <div >
            <table className='w-full max-w-4xl bg-white border borer-gray-200 max-sm:text-sm'>
                <thead>
                    ...
                    {applicants.filter(item=>item.jobId && item.userId).map((applicant,index)=>(
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='py-2 px-4 border-b text-center flex items-center'> 
                                <img className=' w-10 h-10 roudned-full mr-3 max-sm:hidden' src={applicant.userId.image} alt="" />
                            ...
                            <td className='py-2 px-4 border-b '>
                                ...
                                href={applicant.userId.resume} target='_blank'>
                                    Resume <img className='h-8' src={assets.downloadIcon} alt="" />
                                </a>
                            </td>
